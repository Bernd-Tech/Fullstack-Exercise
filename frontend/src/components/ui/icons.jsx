...
export const PlantIcon = ({
  ...
  return (
    <svg
      ...
      stroke-linecap="round"
      stroke-linejoin="round"
      class={`icon icon-tabler icons-tabler-outline icon-tabler-plant-2 w-${size} h-${size}`}
    >
...
export const HomeIcon = ({ size, fill = "currentColor" }) => {
  return (
    <svg className={`w-${size} h-${size}`} viewBox="0 0 640 640">
      <path
        fill={fill}
